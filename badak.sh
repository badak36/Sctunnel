...
echo -e "\033[33m# // Author: SANZ VPN STORES\e[0m"
echo -e "\033[33m# // Description: Xray Menu Management\e[0m"
echo -e "\033[33m# // email: no\e[0m"
echo -e "\033[33m# // telegram: t.me/sanzSTORES0\e[0m"
echo -e "\033[33m# //====================================\e[0m"
sleep 1
Green="\e[92;1m"
RED="\033[31m"
...
LOGO() {
    ...
    echo -e " ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───"
    echo -e " ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───"
    echo -e "    │    ${YELLOW}Copyright${FONT} (C)${GRAY}https://t.me/badakservice$NC   │"
    echo -e "    └───────────────────────────────────────────────┘"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${RED}─────────────────────────────────────────────────${NC}"
echo -e "  Welcome To badak Script${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e "     This Will Quick Setup VPN Server On Your Server"
echo -e "         Author : ${green}subang Tunnel  ${NC}${YELLOW}(${NC} ${green}Project ${NC}${YELLOW})${NC}"
echo -e "       © Recode By Subang ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${RED}─────────────────────────────────────────────────${NC}"
echo ""
sleep 4
###### IZIN SC 
...
data_ip="https://raw.githubusercontent.com/badak36/regip/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/badakservice"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/badak36/regip/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/badak36/regip/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/badak36/regip/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/badak36/Sctunnel/main/"
...
function notif_bot() {
    USRSC=$(curl https://raw.githubusercontent.com/badak36/regip/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(curl https://raw.githubusercontent.com/badak36/regip/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/badakservice"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/karlstore0/2"}]]}'
